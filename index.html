...
<div class="container">
    <div class="left">
        ...
        <div class="content" id="content">
            <h2>BIO</h2>
            <p>Information about Jesse Young.</p>
        </div>
    </div>
    <div class="right">
...
<script type="module">
    ...
    function createWireframe(type) {
        ...
        switch(type) {
            case 'bio':
                geometry = new THREE.IcosahedronGeometry(1.2, 1); // placeholder "head" shape
                break;
            case 'text':
    ...
    document.querySelectorAll('.tab').forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            content.innerHTML = `<h2>${tabName.toUpperCase()}</h2><p>Content for ${tabName}.</p>`;

            createWireframe(tabName);
        });
    });

    // Initialize with BIO shape
    createWireframe('bio');
</script>
